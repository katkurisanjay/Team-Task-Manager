    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg-secondary)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div className="card" style={{ padding: '28px 28px' }}>
          ...
          <p style={{ fontSize: 13.5, color: 'var(--text-secondary)', marginBottom: 22 }}>Sign in to your account to continue.</p>
          ...
          <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 15 }}>
            ...
            <button
              ...
              type="submit"
              disabled={loading}
              style={{ width: '100%', justifyContent: 'center', padding: '9px 14px', marginTop: 2 }}
            >
